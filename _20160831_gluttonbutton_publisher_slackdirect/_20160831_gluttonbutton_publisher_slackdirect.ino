...
const char* SlackWebhookURL = "/services/T189MH94P/B23AHEP1U/NblLC4ZswfJUU0DH8jt50sR4";
...
void slack_publish() {
 String channel = "#food";
 String username = "Glutton Button";

 
  Serial.println("Here's the slack message");
 if (valCurrentSwitchState == 0){
   message = "Someone has reported there is *no longer food* in the break room. :disappointed: ";
  } 
else  if (valCurrentSwitchState == 1){
  message = "Some kind stranger has reported that *there is food* in the break room! :poultry_leg: :strawberry: ";
  }
else {
  message = "value is EMPTY. Something is wrong.";
  Serial.println("value is EMPTY");
  }
 ...
 String PostData="payload={\"channel\": \"" + channel + "\", \"username\": \"" + username + "\", \"text\": \"" + message + "\", \"icon_emoji\": \":hamburger2:\"}";
